    ...
    <>
      ...
      {showBanner && (
        <div className="top-banner">
          <img src="src/components/img2/topbar_img.jpg" alt="Banner Sale" />
      ...
      <div className="top-bar">
        <div className="container">
          <div className="top-bar-left">
            Hotline mua hàng: <strong>0964942121</strong> (8:30 - 21:30, Tất cả các
            ngày trong tuần)
      ...
      <header className="header">
        <div className="container header-content">
          ...
          <div className="logo">
            <Link to="/">
              <img src="src/components/img2/logo.png" alt="Torano" />
            </Link>
          </div>
            ...
            <ul>
              ...
              <li className="has-dropdown">
                ...
                <ul className="dropdown">
                  <li><Link to="#">Sale 70%</Link></li>
                  <li><Link to="#">Sale 60%</Link></li>
                  <li><Link to="#">Sale 50%</Link></li>
                </ul>
              </li>
              ...
              <li className="has-dropdown">
                ...
                <ul className="dropdown">
                  <li><Link to="#">Quần dài kaki</Link></li>
                  <li><Link to="#">Quần gió</Link></li>
